...
## loop time: 371982.687000, request 4 to http://localhost:3000/aio success
## loop time: 371983.687000, order: 1, result: b'{"delay":5}'
## loop time: 371983.687000, request 1 to http://localhost:3000/aio success
## loop time: 371985.687000, order: 2, result: b'{"delay":7}'
## loop time: 371985.687000, request 2 to http://localhost:3000/aio success
## loop time: 371991.687000, order: 3, result: b'{"delay":13}'
## loop time: 371991.687000, request 3 to http://localhost:3000/aio success
## loop time: 371996.687000, order: 0, result: b'{"delay":18}'
## loop time: 371996.687000, request 0 to http://localhost:3000/aio success
## cost 18.041001
